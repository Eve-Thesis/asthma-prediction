...
combinations = [{'lr1': 1e-05, 'lr2': 1e-04, 'lr_decay': 0.8, 'reg_l2': 1e-06, 'dropout_rate': 0.3, 'num_units': 1024,
                 'trained_layers': 12, 'model_type': 'resnet'},
                {'lr1': 1e-05, 'lr2': 1e-04, 'lr_decay': 0.8, 'reg_l2': 1e-06, 'dropout_rate': 0.3, 'num_units': 512,
                 'trained_layers': 12, 'model_type': 'resnet'},
                {'lr1': 1e-05, 'lr2': 1e-04, 'lr_decay': 0.8, 'reg_l2': 1e-05, 'dropout_rate': 0.3, 'num_units': 512,
                 'trained_layers': 12, 'model_type': 'densenet'},
                {'lr1': 1e-05, 'lr2': 1e-04, 'lr_decay': 0.8, 'reg_l2': 1e-04, 'dropout_rate': 0.3, 'num_units': 206,
                 'trained_layers': 12, 'model_type': 'densenet'}]
