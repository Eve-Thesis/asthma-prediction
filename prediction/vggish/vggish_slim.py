...
def define_vggish_slim(training=False):
    ...
    with slim.arg_scope(
            ...
            weights_initializer=tf.compat.v1.truncated_normal_initializer(stddev=params.INIT_STDDEV),
        ...
        features = tf.compat.v1.placeholder(tf.float32, shape=(None, params.NUM_FRAMES, params.NUM_BANDS),
                                            name="input_features")
